...
#data_path = r'/mnt/cuizhen/Data/CVPR2013Bechmark_Color/'
#cache_path = r'/mnt/cuizhen/Results/OTB_CVPR18_Final3/'
data_path =r'/data3/TB-100/OTB2015'
cache_path = r'/data2/wangchaoqun/code/SFT1/SFT_OTB/Results1'
...
vgg_batch_size = 1
vgg_out_layers =  [0]#np.asarray((10,11,12,14,15,16))
vgg_out_layers2 = [6, 7, 8, 10, 11, 12, 14, 15,16]# np.asarray((1)) # scale
...
update_factor = 0.009 # Jogging learning 0.005, others 0.015
cf_nframe_update = 1
...
#sparam_angles = np.float32(np.asarray([0])/180.0*np.pi)
sparam_angles = np.float32(np.asarray([0])/180.0*np.pi)
